...
| ASM-002 | TECHNICAL | Live IOSv lab dropped per ACR-003 (no licensed image, no pay); lab proof is fixtures + dry-run + drill | n/a | Re-add lab bring-up task if an image is procured | OWNER | REJECTED | NO |
